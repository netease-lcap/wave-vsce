    ...
    sidebar: {
      '/spec': [
        ...
        },
        {
          ...
          collapsed: true,
          items: [
            { text: '12.1 Bash', link: '/spec#tool-bash' },
            { text: '12.2 Read', link: '/spec#tool-read' },
            { text: '12.3 Glob', link: '/spec#tool-glob' },
            { text: '12.4 Grep', link: '/spec#tool-grep' },
            { text: '12.5 Write', link: '/spec#tool-write' },
            { text: '12.6 Edit', link: '/spec#tool-edit' },
            { text: '12.7 LSP', link: '/spec#tool-lsp' },
            { text: '12.8 AskUserQuestion', link: '/spec#tool-askuser' },
            { text: '12.9 WebFetch', link: '/spec#tool-webfetch' },
            { text: '12.10 ToolSearch', link: '/spec#tool-toolsearch' },
            { text: '12.11 Worktree', link: '/spec#tool-worktree' },
            { text: '12.12 Cron', link: '/spec#tool-cron' },
            { text: '12.13 Task', link: '/spec#tool-task' },
            { text: '12.14 TaskStop', link: '/spec#tool-taskstop' },
          ],
        },
      ],
    },

    ...
    sidebar: {
      '/spec': [
        ...
        },
        {
          ...
          collapsed: true,
          items: [
            { text: '9.1 AGENTS.md 文件', link: '/spec#agents-md' },
            { text: '9.2 消息压缩', link: '/spec#mechanism-context-management' },
            { text: '9.3 自动记忆系统', link: '/spec#mechanism-auto-memory' },
            { text: '9.4 记忆规则', link: '/spec#mechanism-memory-rules' },
          ],
        },
        {
          text: '10. 配置管理',
          collapsed: false,
          items: [
            { text: '10.1 配置设置', link: '/spec#configuration-settings' },
            { text: '10.2 语言设置', link: '/spec#language-settings' },
            {
        ...
        },
        {
          ...
          collapsed: false,
          items: [
            { text: '12.1 导出器', link: '/spec#otel-exporters' },
            { text: '12.2 Span 体系', link: '/spec#otel-spans' },
            { text: '12.3 事件日志', link: '/spec#otel-events' },
            { text: '12.4 PII 保护', link: '/spec#otel-privacy' },
            { text: '12.5 可靠性保障', link: '/spec#otel-reliability' },
          ],
        },
        {
          text: '13. 完整工具清单',
          collapsed: true,
          items: [
            { text: '13.1 Bash', link: '/spec#tool-bash' },
            { text: '13.2 Read', link: '/spec#tool-read' },
            { text: '13.3 Glob', link: '/spec#tool-glob' },
            { text: '13.4 Grep', link: '/spec#tool-grep' },
            { text: '13.5 Write', link: '/spec#tool-write' },
            { text: '13.6 Edit', link: '/spec#tool-edit' },
            { text: '13.7 LSP', link: '/spec#tool-lsp' },
            { text: '13.8 AskUserQuestion', link: '/spec#tool-askuser' },
            { text: '13.9 WebFetch', link: '/spec#tool-webfetch' },
            { text: '13.10 ToolSearch', link: '/spec#tool-toolsearch' },
            { text: '13.11 Worktree', link: '/spec#tool-worktree' },
            { text: '13.12 Cron', link: '/spec#tool-cron' },
            { text: '13.13 Task', link: '/spec#tool-task' },
            { text: '13.14 TaskStop', link: '/spec#tool-taskstop' },
          ],
        },
      ],
    },

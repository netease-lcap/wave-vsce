...
### 12.8 AskUserQuestion — 交互式提问 {#tool-askuser}
...
### 12.9 WebFetch — 网页内容抓取 {#tool-webfetch}
...
### 12.10 ToolSearch — 延迟加载工具发现 {#tool-toolsearch}
...
### 12.11 EnterWorktree / ExitWorktree — Git Worktree 隔离 {#tool-worktree}
...
### 12.12 CronCreate / CronDelete / CronList — 定时任务 {#tool-cron}
...
### 12.13 TaskCreate / TaskGet / TaskUpdate / TaskList — 任务管理 {#tool-task}
...
### 12.14 TaskStop — 中止后台任务 {#tool-taskstop}

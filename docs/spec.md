...
## 9. 核心机制 {#core-mechanisms}

### 9.1 消息压缩 (Context Management) {#mechanism-context-management}
...
### 9.2 自动记忆系统 (Auto Memory) {#mechanism-auto-memory}
...
### 9.3 记忆规则 (Memory Rules) {#mechanism-memory-rules}
...
### 9.4 后台任务系统 {#mechanism-background-tasks}
...
### 9.5 会话恢复与多会话 {#mechanism-session-restore}
...
### 9.6 文件修改回滚 (Reversion) {#mechanism-reversion}
...
## 10. 会话与配置管理 {#session-config-management}

### 10.1 会话管理 {#session-management}
...
### 10.2 配置设置 {#configuration-settings}
...
## 12. 内置 Skills 与 Subagents {#builtin-skills-subagents}

### 12.1 Settings Skill {#settings-skill}
...
### 12.2 其他内置 Skills {#other-builtin-skills}
...
### 12.3 内置 Subagents {#builtin-subagents}

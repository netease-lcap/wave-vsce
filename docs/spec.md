...
### 8.8 AskUserQuestion — 交互式提问 {#tool-askuser}
...
### 8.9 WebFetch — 网页内容抓取 {#tool-webfetch}
...
### 8.10 ToolSearch — 延迟加载工具发现 {#tool-toolsearch}
...
### 8.11 EnterWorktree / ExitWorktree — Git Worktree 隔离 {#tool-worktree}
...
### 8.12 CronCreate / CronDelete / CronList — 定时任务 {#tool-cron}
...
### 8.13 TaskCreate / TaskGet / TaskUpdate / TaskList — 任务管理 {#tool-task}
...
### 8.14 TaskStop — 中止后台任务 {#tool-taskstop}
...
## 9. 会话与持久化 {#session-persistence}

### 9.1 会话恢复与多会话 {#mechanism-session-restore}
...
### 9.2 文件修改回滚 (Reversion) {#mechanism-reversion}
...
## 11. 配置管理 {#config-management}

### 11.1 配置设置 {#configuration-settings}
...
### 12.4 官方插件市场 {#plugin-marketplaces}
...
#### 12.4.6 commit-skills {#plugin-commit-skills}
...
#### 12.4.8 deep-wiki {#plugin-deep-wiki}
...
## 13. 内置 Skills 与 Subagents {#builtin-skills-subagents}

### 13.1 Settings Skill {#settings-skill}
...
### 13.2 其他内置 Skills {#other-builtin-skills}
...
### 13.3 内置 Subagents {#builtin-subagents}
